          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Delivering enterprise-grade cloud infrastructure and development tools. Trusted by
                Fortune 500 companies and innovative startups worldwide.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">2500 Innovation Drive, Tech Hub</span>
              </div>
            </div>
